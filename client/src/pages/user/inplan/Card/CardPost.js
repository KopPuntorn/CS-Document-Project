...
const downloadFile = async (id, path, mimetype) => {
      try {
        const result = await axios.get(`https://superdoc-ewdetiojvq-as.a.run.app/uploads/${id}`, {
          responseType: 'blob'
        });
    ...
    return (
        <div className="card-post">
            ...
            <div className="card-post-content">
               ...
               <a href={`https://superdoc-ewdetiojvq-as.a.run.app/uploads/${CardData.pic}`} target="_blank" > 
