...
function User() {
  ...
  const downloadFile = async (id, path, mimetype) => {
    try {
      const result = await axios.get(`http://localhost:5000/uploads/${id}`, {
        responseType: 'blob'
      });
  ...
  return (
    ...
    <div className="body-home">
                ...
                {(() => {
                  switch (searchValue) {
                    case false:
                      return <div><div className="headtext">กรุณากรอกข้อมูลที่ต้องการสืบค้น</div>
                    ...
                    case true:
                      return <div className="chblog-table"><div className="headtext">ผลลัพธ์การสืบค้น</div></div>
                        default:
                          return null
                      }
                    })()}
